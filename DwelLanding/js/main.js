...
document.addEventListener('DOMContentLoaded', function() {
                ...
                datasets: [
                    {
                        ...
                        borderColor: '#022E35',
                        backgroundColor: 'rgba(2, 46, 53, 0.1)',
                        borderWidth: 3,
                        fill: true,
                        tension: 0.4,
                        pointRadius: 6,
                        pointHoverRadius: 8,
                        pointBackgroundColor: '#022E35',
                    ...
                    },
                    {
                        ...
                        borderColor: '#0EBEC1',
                        backgroundColor: 'rgba(14, 190, 193, 0.1)',
                        borderWidth: 3,
                        fill: true,
                        tension: 0.4,
                        pointRadius: 6,
                        pointHoverRadius: 8,
                        pointBackgroundColor: '#0EBEC1',
                        pointBorderColor: '#fff',
                        pointBorderWidth: 2
                    }
                ]
    ...
    /* // just text
    // Observe stat numbers for no counter animation
    ...
    // ============================================
    console.log('%c DWEL Platform ', 'background: #022E35; color: white; font-size: 20px; padding: 10px;');
    console.log('%c Balancing Work & Caregiving ', 'font-size: 14px; color: #022E35;');
    console.log('%c For more information: info@dwel.com ', 'font-size: 12px; color: #5A6A7A;');
